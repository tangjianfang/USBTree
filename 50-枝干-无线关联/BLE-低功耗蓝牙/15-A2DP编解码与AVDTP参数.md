...
#41 | 70/05 EL 断言样本 | findings(0) | actions(0) | result(blocked, 8/8) | diff(0) | USB2 电气合规 PDF 文本层提取异常（字体表为主），EL 断言样本无法自动比对——留待实验室口径
#42 | 15-A2DP AAC 位段 | findings(0) | actions(1) | result(green+no-progress, 8/8) | diff(+2行) | Object Type 位段与 §4.5.2.1 一致
