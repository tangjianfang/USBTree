...
| tFirstSourceCap（首次广播 Source Cap） | 100 | — | 250 | ms ※ | PD 3.x 定时表；内核未定义此宏，维持公开通行值 |
| tPPSRequest（PPS 保活重请求） | 4 | 6 | 7.5 | s | PD 3.x PPS；内核 PD_T_PPS_REQUEST=6 s（典型值印证，min/max 维持 ※见 PD 规范） |
